...
const Toolbar: React.FC<ToolbarProps> = (props) => {
  return (
    <div className="max-h-11 min-h-11 relative z-7 flex flex-row justify-between items-center left-0 right-2 top-0 text-inherit whitespace-nowrap pl-3 bg-white font-normal border-b border-[#c2c5c8]">
